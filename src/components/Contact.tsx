...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="relative py-24 bg-white overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 w-80 h-80 z-0 bg-blue-50 rounded-full opacity-70 pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-72 h-72 z-0 bg-cyan-50 rounded-full opacity-70 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-4">
            {contactDetails.map(({ icon: Icon, label, value, href, color, bg }, i) => (
              <motion.div
                ...
                className="flex items-start gap-5 p-5 rounded-2xl bg-slate-50 border border-slate-100 hover:border-blue-200 hover:bg-blue-50/40 transition-all duration-300 group"
              >
            ...
            <motion.div
              ...
              className="p-5 rounded-2xl bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-100"
            >
          ...
          <motion.div
            ...
            className="p-6 sm:p-8 rounded-2xl bg-slate-50 border border-slate-100 shadow-sm"
          >
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full flex items-center justify-center gap-2 py-3.5 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold rounded-xl shadow-md shadow-blue-200 hover:shadow-blue-300 transition-all duration-200 text-sm"
              >
